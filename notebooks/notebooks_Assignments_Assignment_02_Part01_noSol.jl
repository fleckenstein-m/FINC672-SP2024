...
# ╔═╡ ce1be57b-3d94-4f28-a307-8bafc01d9651
	...
	<p style="padding-bottom:1cm"> </p>
	<p align=center style="font-size:25px; font-family:family:Georgia"> <b> Assignment 02 - Part 1: Call Options </b> <p>
	<p style="padding-bottom:1cm"> </p>
...
where $C$ is the call option price (paid today). The first term $\max()$ represents the payoff at expiration, while the second term ($e^{m y}C$) subtracts the capitalized value of the option price (premium) paid at inception of the contract.
...
md"""
## Question 2
Plot the profit of the call option when the strike price is 5.
