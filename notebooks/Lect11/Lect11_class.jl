...
printmat([ERₚ_3';StdRₚ_3']*100,colNames=["B","1","2","3"],rowNames=["mean","std"])
...
# 	#1
# 	p_MV3 = scatter!(p_MV2,[df_MV_μσ[1,:P1]], [df_MV_μσ[2,:P1]], markershape=:diamond,markersize=3, label="")
# 	annotate!(p_MV3,[df_MV_μσ[2,:P1]+0.005],[df_MV_μσ[1,:P1]],("1",12,:green))
	
# 	#2
# 	scatter!(p_MV3,[df_MV_μσ[1,:P2]], [df_MV_μσ[2,:P2]], markershape=:diamond,markersize=3, label="")
# 	annotate!(p_MV3,[df_MV_μσ[2,:P2]+0.005],[df_MV_μσ[1,:P2]],("2",12,:green))
	
# 	#3
# 	scatter!(p_MV3,[df_MV_μσ[1,:P3]], [df_MV_μσ[2,:P3]], markershape=:diamond,markersize=3, label="")
...
md"""
The tangency portfolio is a particular portfolio on the MV frontier of risky and riskfree, where the weights on the risky assets sum to 1. 
...
# begin
# 	p_MVStocks2 = plot(σ_MVStocks,μ_MVStocks, color=:blue, xlim=(0,0.12), ylim=(0,0.03), xlabel=L"\sigma", ylabel=L"\mu", label="MV Frontier", legend=:topleft)	
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "9874bb75b2c7b6d159c452efb27ff3e552dfac21"
