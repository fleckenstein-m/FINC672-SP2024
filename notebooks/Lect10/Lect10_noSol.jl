...
md"""
**Next, let's convert the `:date` column to a type `Date`. We also adjust the prices for stock splits. This is done via the variable "CFACPR" (cumulative adjustment factor).**
"""
...
# ╔═╡ c6f260a0-6c61-4d95-8571-415baddb0c1e
vspace
...
# ╔═╡ bec3a515-0768-4775-8332-a5d8b89ddf86
vspace
