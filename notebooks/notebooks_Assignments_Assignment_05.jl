...
2. Estimate the expected returns of the 10 stocks as the historical average monthly return of the 10 stocks over the 2000 to 2022 period. Use the same data to estimate the covariance matrix of returns.
...
6. Suppose that short-selling is prohibited. Set up the mean-variance optimization problem with a short-sales constraint (all portfolio weight are required to be non-negative) using the Julia libraries `Convex.jl` and `SCS.jl`. Visualize the impact of short-sales constraints by plotting the mean-variance frontier with and without short-sales constraints.
"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "322a118b9521e776204851c95e2792d30d61dc28"
