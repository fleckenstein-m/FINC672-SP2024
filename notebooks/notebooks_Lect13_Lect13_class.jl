...
# ╔═╡ 93771ae9-892f-422f-b4a9-35057ff6bd6c
html"""
	<p style="padding-bottom:1cm"> </p>
	<div align=center style="font-size:25px; font-family:family:Georgia"> FINC-672: Workshop in Finance - Empirical Methods </div>
	<p style="padding-bottom:1cm"> </p>
	<p align=center style="font-size:25px; font-family:family:Georgia"> <b> Single- and Multi-Factor Models</b> <p>
	<p style="padding-bottom:1cm"> </p>
...
# ╔═╡ b67ea55c-3520-42a9-9dc3-ad20549a6ee0
vspace

# ╔═╡ 4b14e5f3-f4b6-4f57-a063-444b55ffbfbf
html"""
<fieldset>      
<legend>Goals for today</legend>      
<br>
  <input type="checkbox" value="">Estimate single and multi-index models and test how good these models are at capturing the covariances of different assets.<br>      
<br>
</fieldset>      
"""

# ╔═╡ a95c7f7a-5cad-4b2d-b3aa-404b5c0e23b3
vspace

# ╔═╡ 666dffaf-263a-4c5d-89ab-20141ebacb0f
# ╠═╡ show_logs = false
begin
	using CSV, DataFrames, Dates,  LinearAlgebra, Statistics, LinearRegressionKit, StatsModels
...
# ╔═╡ c84598f7-74be-467f-ada0-fa217c50f7ef
vspace

# ╔═╡ 409b653a-b007-4933-9581-2a6e9e3ba950
md"""
- In this lecture, we estimate (single and multi-) index models and test how good these models are at capturing the covariances of different assets.
- First, let's define our own OLS function.
"""

# ╔═╡ 39d3c30d-d4fe-4fdd-9b77-e6b5c950a313
vspace
...
# ╔═╡ 0d0831ac-b9c2-4b3f-8ca2-fa0afaddde20
vspace
...
md"""
To begin, let's review the basics of *single index* (or single factor) models.
...
# ╔═╡ 4c5f5248-c9c4-4054-b3ba-289c8401fd44
vspace
...
# ╔═╡ ebc6c457-f8df-4a34-bf2b-8897e6167c6c
vspace
...
# ╔═╡ 6aa50249-1123-411f-82aa-a756bfc90a46
vspace
...
# ╔═╡ 571b5194-cbe2-4540-a087-69251cde34bd
vspace
...
# ╔═╡ 5ea91222-ac86-4ac4-b5cd-c6f3507f44c1
vspace

# ╔═╡ 1a9bf17e-69e1-4d6a-aaaf-8c73f648365d
# begin
# 	FF = CSV.File("lect13_FFmFactorsPs.csv") |> DataFrame

# end

# ╔═╡ 32483a35-5434-4856-9288-f52b4eec4289
vspace
...
# ╔═╡ 3506271f-0bee-4bfd-b954-c4fed7c235d8
vspace
...
# ╔═╡ 7c619b08-3695-45b0-adc0-b5955c803e28
vspace
...
# ╔═╡ 66b9a281-7bbd-4d63-9bf2-63f747e134e5
vspace
...
# ╔═╡ 8367157e-39b4-42ca-ae2d-ad9233f91fec
vspace
...
# ╔═╡ 069cca3c-0f3f-488a-abbd-9e24e601d318
vspace
...
# ╔═╡ d164bca6-614a-40ee-94e9-c6bda9aac89e
vspace
...
# ╔═╡ 27a2ee11-27a6-43ed-8a62-d960576e563d
vspace
...
# ╔═╡ f62936e8-d8a7-41b1-aedc-fcaa305e14fa
vspace
...
# ╔═╡ 1a16c65a-3635-48f4-9988-534ad2c2daef
vspace
...
# ╔═╡ 4ef387f4-393a-43e0-adbd-f8f2c51adcc4
vspace
...
# ╔═╡ 423d550a-0550-4008-b48f-9e5e2b6ac0fa
vspace
...
# ╔═╡ 426befe9-7def-4e08-b944-5449931b2f75
vspace
...
# ╔═╡ 5f628db6-ec54-4abe-af9d-c8d3fea6d817
vspace
...
# ╔═╡ 79538754-e5fb-4898-9bb5-ecb9359ab21f
vspace
...
# ╔═╡ 724f20fa-4f65-47c3-baae-fa32d291036d
vspace
...
# ╔═╡ ea98eaa9-50b5-4a92-98f5-8af71567db63
vspace

# ╔═╡ c446f7c5-2660-48c3-bae6-1dd94eb8933f
html"""
<fieldset>      
<legend>Goals for today</legend>      
<br>
  <input type="checkbox" value="" checked>Estimate single and multi-index models and test how good these models are at capturing the covariances of different assets.<br>      
<br>
</fieldset>      
"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "38273d9d25c3663e69f957159ce59e2da00040f9"
...
git-tree-sha1 = "a2f9747f97f30b9aa19dfdfb7992600bb116d8c8"
