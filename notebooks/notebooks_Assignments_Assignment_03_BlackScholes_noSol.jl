...
- To answer the following questions assume that the stock price is $S=42$, and the strike price is $K=42$. Use a riskfree rate of 5 percent. Assume that the time to maturity is six months and that σ is equal to twenty percent.
...
#Set up the variables for the parameters here:
...
# ╠═╡ show_logs = false
#Call and Put option prices with dividend yield
...
md"""
## Question 3
Plot the call option price for strike prices between K=30 and K=60
"""
...
md"""
## Question 4
Plot the put option price for strike prices between K=30 and K=60
"""
